...
const initialMessages: ContactMessage[] = [
  {
    ...
    message: 'I have a question about my tickets for the Hamilton show. Can you help me?',
    category: 'booking',
    status: 'unread',
  ...
  },
  {
    ...
    message: 'We need to book 50 tickets for our company event. Please contact me.',
    category: 'booking',
    status: 'read',
  ...
  },
  {
    ...
    message: 'What is the parking situation at the venue?',
    category: 'general',
    status: 'read',
  ...
  },
  {
    ...
    message: 'We would like to partner with your theater for events.',
  ...
  },
  {
    ...
    message: 'Just wanted to say the show was amazing! Keep up the great work.',
    category: 'feedback',
    status: 'read',
    createdAt: '2024-04-15T19:45:00'
  }
];
...
Thank you for your booking inquiry. I'm happy to assist you with your request.
...
I'll get back to you with availability and pricing shortly.
...
Thank you for bringing this payment issue to our attention. I apologize for any inconvenience.

I have forwarded your concern to our payment processing team. They will investigate and get back to you within 24 hours.
...
Thank you for your interest in partnering with us. We're always excited to explore collaboration opportunities.

Could you please share more details about your organization? I'll connect you with our partnerships team.
...
Thank you for reporting this technical issue. I understand how frustrating this can be.
...
Our technical team will investigate immediately.
...
const ContactManagement: React.FC = () => {
  ...
  const statsCards = [
    ...
    { title: 'Payment', value: stats.payment, icon: DollarSign, color: 'from-yellow-500 to-yellow-600', delay: 0.25, notification: true, notificationCount: stats.payment },
...
Customer Support Team`}
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-xs text-gray-400">{replyContent.length} characters</p>
            ...
            <div className="bg-gradient-to-br from-sky-50 to-indigo-50 rounded-xl p-4 border border-sky-100">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-gray-600">Category: {selectedMessage?.category}</p>
                </div>
                <div className="flex items-start gap-2">
