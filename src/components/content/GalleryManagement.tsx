...
const galleryValidationSchema = Yup.object({
  ...
  category: Yup.string()
    ...
    .oneOf(
      ["performances", "behind-scenes", "venues", "audience", "costumes"],
      "Invalid category",
    ),
  venue: Yup.string()
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm whitespace-nowrap bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-medium flex items-center gap-2"
            >
        ...
        {filteredImages.length === 0 ? (
          <div className="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <button
              ...
              className="px-5 py-2.5 text-sm whitespace-nowrap bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-medium flex items-center gap-2 mx-auto"
            >
              <Plus className="h-4 w-4" />
              Add New Image
            </button>
              ...
              <form onSubmit={formik.handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <ImageUpload
                    ...
                    onBlur={() => formik.setFieldTouched("image_url", true)}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {formik.touched.photographer &&
                      formik.errors.photographer && (
                        <p className="mt-1 text-sm text-red-600">
                          {formik.errors.photographer}
                        </p>
                      )}
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    className="flex-1 px-6 py-2.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors font-medium flex items-center justify-center gap-2"
                  >
                    {showEditModal ? (
                    ...
                    {showEditModal ? "Update Image" : "Add Image"}
                  </button>
                </div>
              </form>
            </motion.div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600 flex-wrap">
                  <span className="flex items-center gap-1">
                    ...
                    {formatDate(viewingImage.event_date)}
                  </span>
                  <span className="flex items-center gap-1">
                  ...
                  {viewingImage.published_by_name && (
                    <span className="flex items-center gap-1">
                      <User className="h-4 w-4" />
                      By {viewingImage.published_by_name}
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-center gap-4 pt-2 pb-4 border-y border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">
                      {viewingImage.likes.toLocaleString()} likes
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                ...
                <strong>{imageToDelete.title}</strong>? This action cannot be
                undone.
              </p>
