...
import { X, Plus, Trash2, Layers, Save, AlertCircle, Building, Layout } from 'lucide-react';
...
const AddHallModal: React.FC<AddHallModalProps> = ({ onSubmit, onCancel }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (isValid) {
            ...
            onSubmit({ ...formData, features: featuresArray });
        }
    };
            ...
            >
                ...
                <div className="sticky top-0 bg-gradient-to-r bg-deepTeal px-6 py-5 flex justify-between items-center text-white rounded-t-2xl z-10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-white/80 text-sm">Fill in the hall details below</p>
                        </div>
                    </div>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="border-t pt-4">
                        ...
                        {/* Add Type Button - Below the seat types list (full width) */}
                        <div className="mt-4">
                            <button
                                onClick={addSeatType}
