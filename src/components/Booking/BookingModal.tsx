...
const BookingModal: React.FC<BookingModalProps> = ({
  ...
  const getSeatColor = (seat: Seat): string => {
    if (seat.isReserved)
      return "bg-gray-200 dark:bg-gray-600 cursor-not-allowed opacity-50 border-gray-300";
    if (selectedSeats.includes(seat.id))
      return "bg-deepTeal text-white ring-2 ring-deepTeal ring-offset-2 shadow-lg transform scale-105";
    ...
    const sectionColors: Record<SeatSectionKey, string> = {
      ...
      STANDARD:
        "bg-deepTeal/10 hover:bg-deepTeal/20 border-deepTeal/30 text-deepTeal",
    };
              ...
              <div className="bg-white dark:bg-dark-800 rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    {[
                      ...
                      <div key={item.step} className="flex items-center flex-1">
                        <div className="flex flex-col items-center flex-1">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${step >= item.step ? "bg-deepTeal text-white shadow-lg" : "bg-gray-200 dark:bg-dark-700 text-gray-500"}`}
                          >
                            {step > item.step ? (
                        ...
                        {item.step < 3 && (
                          <div className="flex-1 h-0.5 bg-gray-200 dark:bg-dark-700">
                            <div
                              className={`h-full bg-deepTeal transition-all duration-500 ${step > item.step ? "w-full" : "w-0"}`}
                            />
                          </div>
                        )}
                      </div>
                      ...
                      <div className="mb-6 p-4 bg-gradient-to-r from-deepTeal/10 to-deepBlue/5 rounded-xl border border-deepTeal/20 max-w-md mx-auto">
                        ...
                        {selectedSeats.length > 0 && (
                          <div className="flex items-center justify-between font-bold border-t border-deepTeal/20 pt-2 mt-2">
                            <span>Total:</span>
                            <span className="text-deepTeal text-xl">
                            ...
                            {selectedSeats.map((seatId) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <p className="text-sm font-semibold text-deepTeal">
                                    {formatEthiopianBirr(seat?.price || 0)}
                                  </p>
                                </div>
                              );
                            })}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:border-deepTeal focus:ring-2 focus:ring-deepTeal/20 transition-all dark:bg-dark-700 dark:border-dark-600 dark:text-white"
                      ...
                      <div className="max-w-md mx-auto">
                        <div className="mb-6 p-6 bg-gradient-to-r from-deepTeal/10 to-deepBlue/5 rounded-xl border border-deepTeal/20">
                          <div className="flex justify-between items-center mb-4">
                            ...
                            <span className="text-3xl font-bold text-deepTeal">
                              {formatEthiopianBirr(calculateTotal())}
                            </span>
                          </div>
                        ...
                        >
                          {isProcessing ? (
                            ...
                            <>
                              ...
                              Pay {formatEthiopianBirr(calculateTotal())} with
                              Chapa
                            </>
                          )}
                        </button>
                ...
                <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-between">
                  ...
                  {step < 3 ? (
                    <button
                      onClick={handleNext}
                      className="ml-auto px-6 py-2.5 bg-gradient-to-r from-deepTeal to-deepBlue text-white rounded-lg hover:shadow-lg transition-all flex items-center gap-2"
                    >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold flex items-center gap-2">
                  <QrCode className="h-6 w-6 text-deepTeal" /> Your Tickets
                </h2>
            ...
            <div className="p-6">
              <div className="mb-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                <p className="text-green-700 font-medium">
                  ✅ Payment Successful! Booking ID: {bookingData.bookingId} |
              ...
              <div className="space-y-6">
                {bookingData.tickets.map((ticket, index) => (
                  <div
                    key={ticket.ticketId}
                    className="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-deepTeal/30"
                  >
                    <div className="bg-gradient-to-r from-deepTeal to-deepBlue text-white px-5 py-4">
                      <div className="flex justify-between">
                        <div>
                          <h3 className="font-bold">Theatre Hub Ethiopia</h3>
                        </div>
                        <div className="text-right">
                          <p className="text-xs">
                            Ticket {index + 1} of {bookingData.totalSeats}
                          </p>
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex justify-center gap-3 mb-4">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 bg-deepTeal text-white rounded-lg"
                        >
                          {sharedStates[index] ? (
                          ...
                          {sharedStates[index] ? "Shared!" : "Share"}
                        </button>
                        <button
                        ...
                        >
                          ...
                          {copiedStates[index] ? "Copied!" : "Copy QR"}
                        </button>
                      </div>
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="bg-deepTeal/5 p-3 rounded-xl">
                          <div className="text-xs text-gray-500">Seat</div>
                          <p className="font-bold text-2xl text-deepTeal">
                            {ticket.seat}
                          </p>
                          <p className="text-xs">
                      ...
                      <div className="text-center pt-2 border-t">
                        <p className="text-[10px] text-gray-400">
                          Scan this unique QR code at venue entrance
                        </p>
                      </div>
                    </div>
                    <div className="bg-deepTeal/5 px-5 py-3 flex justify-between">
                      <button
                        ...
                        className="px-3 py-1.5 text-sm bg-deepTeal text-white rounded-lg"
                      >
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (w) {
                            w.document.write(
                              `<html><head><title>Ticket</title></head><body>${document.getElementById(`ticket-${index}`)?.outerHTML || ""}</body></html>`,
                            );
                            w.print();
                          }
                        }}
                        className="px-3 py-1.5 text-sm border border-deepTeal/50 text-deepTeal rounded-lg"
                      >
              ...
              <div className="mt-6 flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 bg-deepTeal text-white rounded-lg"
                >
                  <Printer className="h-4 w-4 inline mr-2" /> Print All (
