...
<<<<<<< HEAD
                ...
                <p className="text-white/80 text-lg">
                  Discover amazing events and earn rewards
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-4 min-w-[200px]">
                ...
                <div className="mt-2">
                  <div className="flex justify-between text-[10px] text-white/70 mb-1">
                    ...
                    <span>
                      {loyaltyPoints.nextReward - loyaltyPoints.total} points
                      left
                    </span>
                  </div>
                  <div className="w-full bg-white/20 rounded-full h-1.5">
                    <div
                      ...
                      style={{
                        width: `${(loyaltyPoints.total / loyaltyPoints.nextReward) * 100}%`,
                      }}
                    />
                  </div>
                </div>
...
<<<<<<< HEAD
                ...
                <div className="space-y-4">
                  {events
                    ...
                    .map((event) => (
                      <div
                        key={event.id}
                        className="bg-white rounded-2xl p-4 shadow-lg border border-gray-200 flex gap-4"
                      >
                        <img
            ...
            >
              ...
              <QuickActionButton
                ...
                text="Redeem Points"
                color="warning"
                onClick={() => alert("Redeem points coming soon")}
              />
              <QuickActionButton
                icon={Headphones}
                text="Support"
