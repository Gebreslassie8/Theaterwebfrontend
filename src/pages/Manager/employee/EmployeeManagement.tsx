...
interface Employee {
  ...
  joinDate?: string;
  assignedRole: "salesperson" | "scanner" | "manager" | "admin";
        ...
        return (
          <div className="flex flex-col">
            ...
            {row.deactivationReason && row.status === "Inactive" && (
              ...
              >
                Reason:{" "}
                {row.deactivationReason.length > 30
                  ? row.deactivationReason.substring(0, 30) + "..."
...
>>>>>>> 23fa60fa38acab6993f132dd267d77ab23e9a4b7
      ...
      <button
        onClick={() => {
          ...
          // Use a local state or directly show delete modal
  ...
  // Handle delete click without unused state
  ...
  const dashboardCards = [
    ...
    },
    {
      ...
      delay: 0.15,
      link: "/manager/employees?status=active",
    },
    {
      title: "Inactive",
      ...
      delay: 0.2,
      link: "/manager/employees?status=inactive",
    },
    {
      title: "On Leave",
      ...
      delay: 0.22,
      link: "/manager/employees?status=onleave",
    },
    {
      title: "Total Payroll",
      value: `Br ${stats.totalPayroll.toLocaleString()}`,
      icon: CoinsIcon,
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="Attendance problems">
                    Attendance problems
                  </option>
                  <option value="Policy violation">Policy violation</option>
                  <option value="Requested by employee">
        ...
        {showDeleteModal && employeeToDelete && (
          <DeleteConfirmModal
            employee={employeeToDelete as any}
