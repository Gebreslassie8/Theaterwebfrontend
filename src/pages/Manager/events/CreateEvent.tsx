  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {viewMode === 'table' && (
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            {/* FinancialReports-style stat cards */}
            <div className="grid grid-cols-1 md:grid-cols-5 gap-5 mb-8">
              {/* Events Card */}
              <motion.div variants={itemVariants} className="bg-white rounded-xl p-4 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300">
              ...
              <motion.div variants={itemVariants} className="bg-white rounded-xl p-4 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500">Manager Earnings</p>
                    <p className="text-xl font-bold text-gray-900">${totalManagerEarnings.toLocaleString()}</p>
                  </div>
                </div>
              </motion.div>

              {/* Create Event Card – contains button */}
              <motion.div variants={itemVariants} className="bg-white rounded-xl p-4 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center gap-3">
